...
const Skills = () => {
  ...
  const mainExplanationContent = {
    ...
    explanation: "I'm a passionate and detail-oriented developer with a strong interest in IoT, data systems, and digital design. My work focuses on building reliable, scalable, and user-friendly solutions that bridge technology and real-world impact.",
  ...
  return (
    <section id="skills" className="min-h-screen skills p-20 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 w-full max-w-[1064px] mx-auto">
        <div className="bg-beige p-4 flex flex-col items-center justify-start  h-full"> {/* h-full to stretch */}
        ...
        <div className="md:col-span-3 flex flex-col gap-4">
          <div className="bg-beige p-6 flex flex-col items-center text-center h-auto"> {/* h-auto for content sizing */}
            <svg className="text-navy-blue fill-current mb-4" width={64} height={64} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d={mainExplanationContent.icon} />
            </svg>
            <p className="text-2xl text-navy-blue font-Inter font-semibold mb-2" >{mainExplanationContent.title}</p>
            <p className="text-base text-navy-blue font-Inter mb-4" >{mainExplanationContent.explanation}</p>
            <p className="text-lg font-medium text-navy-blue font-Inter" >{mainExplanationContent.level}</p>
          </div>
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 gap-4 p-4 bg-beige flex-grow"> 
            {filteredSkillsIcons.length > 0 ? (
              filteredSkillsIcons.map((skill, index) => (
                <div key={index} className="flex flex-col text-navy-blue items-center justify-center text-center">
